...
public class MySubnetUtils {
     ...
     */
    public MySubnetUtils(String address, String mask) {
     ...
     */
    public void calculate(String mask) {
     ...
     */
    public int matchAddress(Matcher matcher) {
        int addr = 0;
        for (int i = 1; i <= 4; ++i) {
     ...
     */
    public int rangeCheck(int value, int begin, int end) {
