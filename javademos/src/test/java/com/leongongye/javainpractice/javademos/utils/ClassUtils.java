 ...
 *
 * @author leon
 * @version $Id: ArrayUtil.java, v 0.1 2016年2月4日 上午11:18:19 leon Exp $
 */
public class ClassUtils {
     ...
     * 例如：
     * <pre>
     *  ClassUtil.getShortClassNameForObject(Boolean.TRUE) = "Boolean" ClassUtil.getShortClassNameForObject(new Boolean[10]) =
     *  "Boolean[]" ClassUtil.getShortClassNameForObject(new int[1][2]) = "int[][]"
     *  </pre>
     *
     *
     * @param object 要查看的对象
     ...
     * 例如：
     * <pre>
     *  ClassUtil.getShortClassName(Boolean.class) = "Boolean" ClassUtil.getShortClassName(Boolean[].class) = "Boolean[]" ClassUtil
     *  .getShortClassName(int[][].class) = "int[][]" ClassUtil.getShortClassName(Map.Entry.class) = "Map.Entry"
     *  </pre>
     *
     *
     * @param clazz 要查看的类
     ...
     * 例如：
     * <pre>
     *  ClassUtil.getShortClassName(Boolean.class.getName()) = "Boolean" ClassUtil.getShortClassName(Boolean[].class.getName()) =
     *  "Boolean[]" ClassUtil.getShortClassName(int[][].class.getName()) = "int[][]" ClassUtil.getShortClassName(Map.Entry.class.getName
     *  ()) = "Map.Entry"
     *  </pre>
     *
     *
    ...
    public static boolean isAssignable(Class clazz, Class fromClass) {
        ...
        if (clazz.isPrimitive()) {
            ...
            if (Integer.TYPE.equals(clazz)) {
                return Integer.class.equals(fromClass) || Byte.TYPE.equals(fromClass) || Byte.class.equals(fromClass) || Short.TYPE.equals(
                        fromClass) || Short.class.equals(fromClass) || Character.TYPE.equals(fromClass) || Character.class.equals(
                        (fromClass));
            }

            // long可以接受：long、int、byte、short、char
            if (Long.TYPE.equals(clazz)) {
                return Long.class.equals(fromClass) || Integer.TYPE.equals(fromClass) || Integer.class.equals(fromClass) || Byte.TYPE
                        .equals(fromClass) || Byte.class.equals(fromClass) || Short.TYPE.equals(fromClass) || Short.class.equals(fromClass)
                        || Character.TYPE.equals(fromClass) || Character.class.equals((fromClass));
            }

            // float可以接受：float, long, int, byte, short, char
            if (Float.TYPE.equals(clazz)) {
                return Float.class.equals(fromClass) || Long.TYPE.equals(fromClass) || Long.class.equals(fromClass) || Integer.TYPE.equals(
                        fromClass) || Integer.class.equals(fromClass) || Byte.TYPE.equals(fromClass) || Byte.class.equals(fromClass)
            ...
            if (Double.TYPE.equals(clazz)) {
                return Double.class.equals(fromClass) || Float.TYPE.equals(fromClass) || Float.class.equals(fromClass) || Long.TYPE.equals(
                        fromClass) || Long.class.equals(fromClass) || Integer.TYPE.equals(fromClass) || Integer.class.equals(fromClass)
                        || Byte.TYPE.equals(fromClass) || Byte.class.equals(fromClass) || Short.TYPE.equals(fromClass) || Short.class
