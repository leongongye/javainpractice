 ...
 */
package com.leongongye.javainpractice.javademos.model;

import com.leongongye.javainpractice.javademos.utils.MySubnetUtils.SubnetInfo;
 ...
 *
 * @author leon
 * @version $Id: Subnet.java, v 0.1 2016年9月22日 上午10:30:14 leon Exp $
 */
public class Subnet {
    /* Mask to convert unsigned int to a long (i.e. keep 32 bits) */
    public static final long    UNSIGNED_INT_MASK = 0x0FFFFFFFFL;
    ...
    public String fromInteger(int val) {
    ...
    public String toString() {
        ...
        buf.append("CIDR Signature:\t[").append(getCidrSignature()).append("]").append(" Netmask: [").append(getNetmask()).append("]\n")
                .append("Network:\t[").append(getNetworkAddress()).append("]\n").append("Broadcast:\t[").append(getBroadcastAddress())
                .append("]\n").append("First Address:\t[").append(getLowAddress()).append("]\n").append("Last Address:\t[").append(
                getHighAddress()).append("]\n").append("# Addresses:\t[").append(getAddressCount()).append("]\n");
        return buf.toString();
    }
