...
public class StringUtils {
     ...
     * @return 如果字符串非<code>null</code>并且全由unicode字母数字组成，则返回<code>true</code>
     */
    public static boolean isUpperalphaNumeric(String str) {
        if (str == null) {
            return false;
        }
        int length = str.length();
    ...
    public static String join(Object[] array, String separator) {
        ...
        int bufSize = (arraySize == 0) ? 0
                : (arraySize * (((array[0] == null) ? 16 : array[0].toString().length()) + ((separator != null) ? separator.length() : 0)));
