...
public class MyExpect {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MyExpect.class);
    ...
    public MyExpect(InputStream input, OutputStream output) {
        try {
    ...
    /**
     * @return the spawned process, if this {@link MyExpect} object is created by
     *         spawning a process
     */
     ...
     *         spawned process
     */
    public static MyExpect spawn(String command) {
        ...
        MyExpect retv = new MyExpect(p.getInputStream(), p.getOutputStream());
        retv.process = p;
        return retv;
    }
    ...
    public static final int RETV_TIMEOUT = -1, RETV_EOF = -2, RETV_IOEXCEPTION = -9;
    ...
    //    private static Layout layout = new PatternLayout(PatternLayout.TTCC_CONVERSION_PATTERN);
    //
    ...
    public static void forwardInputStreamTo(PrintStream duplicatedTo) {
        MyExpect.duplicatedTo = duplicatedTo;
    }
